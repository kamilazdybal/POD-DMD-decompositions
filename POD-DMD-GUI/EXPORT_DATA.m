...
% Save the directory of a new folder to a variable:
...
% Saving results under the case folder:
if String_An_Type == '1DS'
    ...
    if String_Dec_Type == 'DMD'
        ...
        % Save the results to the case folder:
    ...
    elseif String_Dec_Type == 'POD'
        ...
        % Save the results to that folder:
...
% Print graphical results (modes & other)
if String_An_Type == '1DS'
...
elseif j>r;
    ...
    elseif String_Dec_Type == 'DMD'
        ...
        %T_modesV = getappdata(0, 'T_modesV');
        bD=getappdata(0,'bU');
